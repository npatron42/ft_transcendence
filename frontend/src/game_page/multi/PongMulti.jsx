...
const PongMulti = ({ roomId, maxScore, powerUp, isTournament, idTournament }) => {
    ...
    useEffect(() => {
        const ws = new WebSocket(`wss://${location.host}/ws/pong/${roomId}/${isTournament}/${idTournament}/?token=${myJwt}`);
    ...
    const renderPowerUp = () => {
        switch (powerUpType) {
            ...
            case 'decrease_paddle':
                return <img src="../../src/assets/game/decrease_paddle.svg" alt="x2" style={{ width: '40px', height: '40px' }} />;
            case 'x2':
